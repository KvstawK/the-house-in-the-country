...
if(typeof wpbs_calendars !== 'undefined'){ 
...
if(typeof wpbs_languages !== 'undefined'){ 
	...
	edit: function edit(props) {
        ...
        wp.element.createElement(SelectControl, {
         ...
         wp.element.createElement(SelectControl, {
            ...
            options: [{ value: '1', label: __('Monday', 'wp-booking-system-search') }, { value: '2', label: __('Tuesday', 'wp-booking-system-search') }, { value: '3', label: __('Wednesday', 'wp-booking-system-search') }, { value: '4', label: __('Thursday', 'wp-booking-system-search') }, { value: '5', label: __('Friday', 'wp-booking-system-search') }, { value: '6', label: __('Saturday', 'wp-booking-system-search') }, { value: '7', label: __('Sunday', 'wp-booking-system-search') }],
            onChange: function onChange(new_value) {
                return props.setAttributes({ start_day: new_value });
            } }),
        wp.element.createElement(SelectControl, {
        ...
        wp.element.createElement(SelectControl, {
					...
					options: [{ value: 'multiple', label: __('Date Range', 'wp-booking-system-search') }, { value: 'single', label: __('Single Day', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
        ...
        wp.element.createElement(TextControl, {
					...
					onChange: function onChange(new_value) {
						return props.setAttributes({ minimum_stay: new_value });
					} }),
        wp.element.createElement(SelectControl, {
					...
					options: [{ value: 'yes', label: __('Yes', 'wp-booking-system-search') }, { value: 'no', label: __('No', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
						return props.setAttributes({ featured_image: new_value });
					} }),
        wp.element.createElement(SelectControl, {
					...
					options: [{ value: 'yes', label: __('Yes', 'wp-booking-system-search') }, { value: 'no', label: __('No', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
						return props.setAttributes({ starting_price: new_value });
					} }),
        wp.element.createElement(SelectControl, {
					label: __('Show Results on Load', 'wp-booking-system-search'),
					value: props.attributes.show_results_on_load,
					options: [{ value: 'yes', label: __('Yes', 'wp-booking-system-search') }, { value: 'no', label: __('No', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
						return props.setAttributes({ show_results_on_load: new_value });
					} }),
        wp.element.createElement(SelectControl, {
					label: __('Results Layout', 'wp-booking-system-search'),
					value: props.attributes.results_layout,
					options: [{ value: 'list', label: __('List', 'wp-booking-system-search') }, { value: 'grid', label: __('Grid', 'wp-booking-system-search') }],
					onChange: function onChange(new_value) {
						return props.setAttributes({ results_layout: new_value });
					} }),
        wp.element.createElement(TextControl, {
					label: __('Results per Page', 'wp-booking-system-search'),
					value: props.attributes.results_per_page,
					onChange: function onChange(new_value) {
						return props.setAttributes({ results_per_page: new_value });
					} }),
        wp.element.createElement(TextControl, {
					label: __('Redirect', 'wp-booking-system-search'),
					value: props.attributes.redirect,
					onChange: function onChange(new_value) {
						return props.setAttributes({ redirect: new_value });
					} }),
			)
		)];
	},
