...
function rc_rentals_reviews_get_average_ratings( $id ) {
...
//add_filter( 'the_content', 'rc_rentals_reviews_display_average_rating' );
//function rc_rentals_reviews_display_average_rating( $content ) {
//
//    global $post;
//
