<div class="rc-datepicker rc-datepicker-check-in">
	<div id="datepickerCheckIn" class="rc-datepicker check-in">
		<label for="arrival" class="paragraph-first-line"><?php esc_html_e('Check-in', 'rc-rentals'); ?></label>
		<input role="combobox" type="text" id="arrival" class="arrival" name="arrival" aria-autocomplete="none" aria-expanded="false" aria-haspopup="dialog" aria-controls="rc-datepicker-check-in-modal" readonly="readonly" aria-label="<?php esc_attr_e('Choose check-in date', 'rc-rentals'); ?>" required placeholder="<?php esc_attr_e('Check-in', 'rc-rentals'); ?>"><div class="rc-calendar-icon" aria-hidden="true"><?php echo wp_get_attachment_image(2218, 'full') ?></div>
		<div role="dialog" aria-modal="true" class="rc-datepicker-check-in-modal" aria-label="<?php esc_attr_e('Choose check-in date', 'rc-rentals'); ?>">
