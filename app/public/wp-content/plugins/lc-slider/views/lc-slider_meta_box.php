...
<div class="lc-slider__options">
    ...
    <div class="lc-slider__options-checkboxes-item">
        ...
        <div class="lc-slider__options-checkboxes-item">
            <div><label for="arrows"><?php esc_html_e('Check if you would like the arrows to appear:', 'lc-slider'); ?></label></div>
            <div>
        ...
        <div class="lc-slider__options-checkboxes-item">
            <div><label for="auto-play"><?php esc_html_e('Check if you would like auto-play:', 'lc-slider'); ?></label></div>
            <div>
        ...
        <div class="lc-slider__options-checkboxes-item">
            <div><label for="gallery"><?php esc_html_e('Check if you would like to have a gallery:', 'lc-slider'); ?></label></div>
            <div>
