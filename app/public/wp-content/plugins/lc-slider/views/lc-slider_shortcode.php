...
<div tabindex="0" id="lc-carousel-<?php echo esc_attr($post->post_name); ?>" aria-roledescription="region" aria-label="<?php echo esc_attr__('Highlighted images of the slider', 'lc-slider'); ?>" class="lc-carousel lc-carousel-<?php echo esc_attr($post->post_name); ?> <?php echo (get_post_meta(get_the_ID(), 'image-appear-disappear-slider', true) ? esc_attr('lc-carousel-image-appear-disappear-type') : (get_post_meta(get_the_ID(), 'gallery', true) ? esc_attr('lc-carousel-gallery') : esc_attr('lc-slider-horizontal-scroll-type'))) ?>
      <?php echo ((get_post_meta(get_the_ID(), 'gallery', true)) ? '' : (get_post_meta(get_the_ID(), '2-slide-carousel', true) ? esc_attr('lc-2-slide-carousel') : (get_post_meta(get_the_ID(), '3-slide-carousel', true) ? esc_attr('lc-3-slide-carousel') : esc_attr('1-slide-carousel')))) ?>
     <?php echo (get_post_meta(get_the_ID(), 'gallery', true) ? esc_attr('lc-gallery') : esc_attr('no-gallery')) ?> <?php echo (get_post_meta(get_the_ID(), 'lightbox', true) ? esc_attr('lc-lightbox') : esc_attr('no-lightbox')) ?> <?php echo (get_post_meta(get_the_ID(), 'arrows', true) ? esc_attr('with-arrows') : esc_attr('no-arrows')) ?> <?php echo (get_post_meta(get_the_ID(), 'auto-play', true) ? esc_attr('with-auto-play') : esc_attr('no-auto-play')) ?>">
	...
	<?php if (get_post_meta( get_the_ID(), 'dots-carousel', true )) : ?>
        ...
        <button type="button" class="dots-slider-btn dots-slider-btn-right" aria-label="<?php esc_html_e('next slides button', 'lc-slider'); ?>" aria-controls="<?php echo $post->post_name; ?>-dots-carousel"><?php echo wp_get_attachment_image(1962, 'full') ?></button><span class="overflow-right"></span>

	<?php endif; ?>

	<?php if (get_post_meta( get_the_ID(), 'arrows', true )) : ?>

        <button type="button" class="lc-carousel__btn lc-carousel__btn-left hide" aria-label="<?php esc_html_e('previous slide button', 'lc-slider'); ?>" aria-controls="<?php echo $post->post_name; ?>-carousel-items"><?php echo wp_get_attachment_image(1962, 'full') ?></button>
...
<div id="<?php echo $post->post_name; ?>-carousel-items" class="lc-carousel__container-sliders" aria-live="polite">
	...
	if(!empty($banner_img) && empty(get_post_meta( get_the_ID(), '2-slide-carousel', true )) && empty(get_post_meta( get_the_ID(), '3-slide-carousel', true ))) :
		foreach ($banner_img as $attachment_id) :
            ...
            <<?php echo $title_tag; ?> class="lc-carousel__container-sliders-slide-content-title"><?php echo $title_text; ?></<?php echo $title_tag; ?>>
            <<?php echo $subtitle_tag; ?> class="lc-carousel__container-sliders-slide-content-caption"><?php echo $subtitle_text; ?></<?php echo $subtitle_tag; ?>>
            <<?php echo $content_tag; ?> class="lc-carousel__container-sliders-slide-content-description"><?php echo $content_text; ?></<?php echo $content_tag; ?>>
        <a class="lc-carousel__container-sliders-slide-content-link" href="<?php echo $button_url ?>"><<?php echo $button_text_tag; ?>><?php echo $button_text ?></<?php echo $button_text_tag; ?>></a>
            </div>
	...
	<?php if (get_post_meta( get_the_ID(), 'arrows', true )) : ?>
        ...
        <button type="button" class="lc-carousel__btn lc-carousel__btn-right" aria-label="<?php esc_html_e('next slide button', 'lc-slider'); ?>" aria-controls="<?php echo $post->post_name; ?>-carousel-items"><?php echo wp_get_attachment_image(1963, 'full') ?></button>
