...
<div class="wpbs-settings-field-wrapper wpbs-settings-field-inline wpbs-settings-field-large">
	...
	<div class="wpbs-settings-field-inner">
        <label for="followup_notification_enable" class="wpbs-checkbox-switch">
            <input type="hidden" name="followup_notification_enable" value="0">
...
<div id="wpbs-email-follow-up-wrapper" class="wpbs-email-follow-up-wrapper wpbs-settings-wrapper <?php echo ( !empty($form_meta['followup_notification_enable'][0]) ) ? 'wpbs-settings-wrapper-show' : '';?>">
    ...
    <div class="wpbs-settings-field-wrapper wpbs-settings-field-inline wpbs-settings-field-large">
        ...
        <div class="wpbs-settings-field-inner">
            <input name="followup_notification_when_to_send" type="number" id="followup_notification_when_to_send" value="<?php echo ( !empty($form_meta['followup_notification_when_to_send'][0]) ) ? esc_attr($form_meta['followup_notification_when_to_send'][0]) : '7';?>" class="regular-text" >
    ...
    <?php $from_email = ( !empty($form_meta['followup_notification_from_email'][0]) ) ? esc_attr($form_meta['followup_notification_from_email'][0]) : (isset($settings['default_from_email']) ? esc_attr($settings['default_from_email']) : '') ?>
    <div class="wpbs-settings-field-wrapper wpbs-settings-field-inline wpbs-settings-field-large">
        ...
        <div class="wpbs-settings-field-inner">
            <input name="followup_notification_from_email" type="text" id="followup_notification_from_email" value="<?php echo $from_email;?>" class="regular-text" >
        </div>
    </div>
