...
<div class="wrap wpbs-wrap wpbs-wrap-settings">
			...
			<?php
				...
				if( ! empty( $tabs ) ) {
					...
					foreach( $tabs as $tab_slug => $tab_name ) {
						...
						// Handle form tabs
						} else if( $tab_slug == 'email' ) {

							include 'view-settings-tab-email.php';
						
						// Handle strings tabs
						} else if( $tab_slug == 'strings' ) {

							include 'view-settings-tab-strings.php';
